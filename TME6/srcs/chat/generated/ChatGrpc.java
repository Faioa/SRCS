...
public final class ChatGrpc {
  ...
  public static final String SERVICE_NAME = "srcs.chat.generated.Chat";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<srcs.chat.generated.SubscribeMessage,
      com.google.protobuf.BoolValue> getSubscribeMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "subscribe",
      requestType = srcs.chat.generated.SubscribeMessage.class,
      responseType = com.google.protobuf.BoolValue.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<srcs.chat.generated.SubscribeMessage,
      com.google.protobuf.BoolValue> getSubscribeMethod() {
    io.grpc.MethodDescriptor<srcs.chat.generated.SubscribeMessage, com.google.protobuf.BoolValue> getSubscribeMethod;
      ...
      synchronized (ChatGrpc.class) {
        if ((getSubscribeMethod = ChatGrpc.getSubscribeMethod) == null) {
          ChatGrpc.getSubscribeMethod = getSubscribeMethod =
              io.grpc.MethodDescriptor.<srcs.chat.generated.SubscribeMessage, com.google.protobuf.BoolValue>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "subscribe"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  srcs.chat.generated.SubscribeMessage.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<srcs.chat.generated.ChatMessage,
      com.google.protobuf.Int32Value> getSendMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "send",
      requestType = srcs.chat.generated.ChatMessage.class,
      responseType = com.google.protobuf.Int32Value.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<srcs.chat.generated.ChatMessage,
      com.google.protobuf.Int32Value> getSendMethod() {
    io.grpc.MethodDescriptor<srcs.chat.generated.ChatMessage, com.google.protobuf.Int32Value> getSendMethod;
    if ((getSendMethod = ChatGrpc.getSendMethod) == null) {
      synchronized (ChatGrpc.class) {
        if ((getSendMethod = ChatGrpc.getSendMethod) == null) {
          ChatGrpc.getSendMethod = getSendMethod =
              io.grpc.MethodDescriptor.<srcs.chat.generated.ChatMessage, com.google.protobuf.Int32Value>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "send"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  srcs.chat.generated.ChatMessage.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
  ...
  private static volatile io.grpc.MethodDescriptor<com.google.protobuf.Empty,
      srcs.chat.generated.ListChatterMessage> getListChatterMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "listChatter",
      requestType = com.google.protobuf.Empty.class,
      responseType = srcs.chat.generated.ListChatterMessage.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.google.protobuf.Empty,
      srcs.chat.generated.ListChatterMessage> getListChatterMethod() {
    io.grpc.MethodDescriptor<com.google.protobuf.Empty, srcs.chat.generated.ListChatterMessage> getListChatterMethod;
    if ((getListChatterMethod = ChatGrpc.getListChatterMethod) == null) {
      synchronized (ChatGrpc.class) {
        if ((getListChatterMethod = ChatGrpc.getListChatterMethod) == null) {
          ChatGrpc.getListChatterMethod = getListChatterMethod =
              io.grpc.MethodDescriptor.<com.google.protobuf.Empty, srcs.chat.generated.ListChatterMessage>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              ...
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  srcs.chat.generated.ListChatterMessage.getDefaultInstance()))
  ...
  public static abstract class ChatImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void subscribe(srcs.chat.generated.SubscribeMessage request,
    ...
    /**
     */
    public void send(srcs.chat.generated.ChatMessage request,
    ...
    public void listChatter(com.google.protobuf.Empty request,
        io.grpc.stub.StreamObserver<srcs.chat.generated.ListChatterMessage> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                srcs.chat.generated.SubscribeMessage,
          ...
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                srcs.chat.generated.ChatMessage,
          ...
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                ...
                srcs.chat.generated.ListChatterMessage>(
  ...
  public static final class ChatBlockingStub extends io.grpc.stub.AbstractBlockingStub<ChatBlockingStub> {
    ...
    /**
     */
    public com.google.protobuf.BoolValue subscribe(srcs.chat.generated.SubscribeMessage request) {
    ...
    /**
     */
    public com.google.protobuf.Int32Value send(srcs.chat.generated.ChatMessage request) {
      return blockingUnaryCall(
    ...
    /**
     */
    public srcs.chat.generated.ListChatterMessage listChatter(com.google.protobuf.Empty request) {
      return blockingUnaryCall(
  ...
  public static final class ChatFutureStub extends io.grpc.stub.AbstractFutureStub<ChatFutureStub> {
    ...
    public com.google.common.util.concurrent.ListenableFuture<com.google.protobuf.BoolValue> subscribe(
        srcs.chat.generated.SubscribeMessage request) {
    ...
    public com.google.common.util.concurrent.ListenableFuture<com.google.protobuf.Int32Value> send(
        srcs.chat.generated.ChatMessage request) {
      return futureUnaryCall(
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<srcs.chat.generated.ListChatterMessage> listChatter(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_SUBSCRIBE:
          serviceImpl.subscribe((srcs.chat.generated.SubscribeMessage) request,
              (io.grpc.stub.StreamObserver<com.google.protobuf.BoolValue>) responseObserver);
          break;
        case METHODID_SEND:
          serviceImpl.send((srcs.chat.generated.ChatMessage) request,
              (io.grpc.stub.StreamObserver<com.google.protobuf.Int32Value>) responseObserver);
          break;
  ...
  private static abstract class ChatBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return srcs.chat.generated.App.getDescriptor();
    }
